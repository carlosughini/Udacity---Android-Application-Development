...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTaskDescription = (EditText) findViewById(R.id.editTextTaskDescription);
    }
    ...
    public void onClickAddTask(View view) {
        ...
        String taskDescription = mEditTaskDescription.getText().toString();
        ...
        if (newUri != null) {
            ...
            Toast.makeText(this, "The URI is: " + newUri, Toast.LENGTH_SHORT).show();
        }

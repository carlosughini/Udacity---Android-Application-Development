...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        String text = "Sharing some text to test";
        shareText(text);
    }
    ...
    public void createYourOwn(View v) {
        String phoneNumber = "tel: 51996166973";
    ...
    /**
     * This method fires off an implicit Intent that opens the dialer or phone application.
